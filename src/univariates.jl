...
islowerbounded(d::Union{D,Type{D}}) where {D<:UnivariateDistribution} = minimum(d) / unit(d) > -Inf
isupperbounded(d::Union{D,Type{D}}) where {D<:UnivariateDistribution} = maximum(d) / unit(d) < +Inf
